...
\hline
\textbf{Student Name} & [Student Name] \\ \hline
\textbf{Enrolment Number} & [Enrolment Number] \\ \hline
\textbf{Section} & [Section] \\ \hline
\textbf{Subject Name} & NoSQL Databases / Advanced DBMS \\ \hline
\textbf{Email Address} & [student.email@university.edu] \\ \hline
\textbf{Contact No:} & [+91-XXXXXXXXXX] \\ \hline
\end{tabularx}
\end{table}
...
1. & [Student Name] & [Student Name] & [Gender] & Indian & [Campus Address] \\ \hline
\end{tabularx}
\end{table}
